...
- Name: smoke.spec.ts >> Smoke Tests >> Admin Portal >> admin should redirect to login when not authenticated
- Location: e2e/smoke.spec.ts:28:9
...
- generic [ref=e4]:
  - generic [ref=e5]:
    - img [ref=e7]
    - heading "Amber Admin" [level=1] [ref=e11]
    - paragraph [ref=e12]: Sign in to manage your Myanmar Heritage store
  - generic [ref=e13]:
    - generic [ref=e14]:
      - generic [ref=e15]:
        - text: Email Address
        - generic [ref=e16]:
          - img [ref=e17]
          - textbox "admin@amber.com" [ref=e20]
      - generic [ref=e21]:
        - text: Password
        - generic [ref=e22]:
          - img [ref=e23]
  ...
  - paragraph [ref=e28]: Protected by Amber Brand Fashion Security. 2026.
```
