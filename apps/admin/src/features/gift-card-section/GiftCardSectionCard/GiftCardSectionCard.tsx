...
import { Gift, Check, Edit2, Trash2, Power } from 'lucide-react';
    ...
    <div className={cn(
      ...
      <div className="aspect-[16/9] bg-[#1A1A1A] relative overflow-hidden flex items-center justify-center p-6">
        ...
        <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-4">
           ...
           <button onClick={() => onDelete(section.id)} className="p-3 bg-white text-destructive hover:bg-destructive hover:text-white transition-colors"><Trash2 size={18}/></button>
        </div>
      </div>
