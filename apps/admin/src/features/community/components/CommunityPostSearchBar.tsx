...
interface CommunityPostSearchBarProps {
  value: string;
...
export const CommunityPostSearchBar: React.FC<CommunityPostSearchBarProps> = ({
  value,
  onChange,
  viewMode,
  onViewModeChange,
    ...
    <div className="flex flex-col md:flex-row gap-4 mb-8">
      <div className="relative flex-1 group">
        ...
        <input
          ...
          placeholder="Search by user, handle, or content..."
