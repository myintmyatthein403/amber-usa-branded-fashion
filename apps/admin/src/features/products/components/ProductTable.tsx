  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
      {products.map((product) => (
        <div key={product.id} className="group relative bg-card border border-border overflow-hidden transition-all duration-700 hover:shadow-2xl hover:shadow-black/5 hover:-translate-y-1">
          ...
          <div className="p-6 space-y-4">
            <div className="flex justify-between items-start gap-4">
              ...
              <div className="text-right">
                <div className="text-sm font-mono font-bold">{product.isUsdPrice ? '$' : 'Ks'}{parseFloat(product.price).toLocaleString()}</div>
