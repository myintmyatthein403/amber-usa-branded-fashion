...
export const ProductSearchBar: React.FC<ProductSearchBarProps> = ({
  ...
  return (
    <div className="flex flex-col md:flex-row gap-6 items-center justify-between bg-card border border-border p-6">
      <div className="relative w-full md:w-96" data-tour="search">
      ...
      <div className="flex items-center gap-2 border border-border p-1 bg-secondary/30" data-tour="view-modes">
        <button 
