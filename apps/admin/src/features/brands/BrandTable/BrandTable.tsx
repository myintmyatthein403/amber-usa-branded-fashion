        ...
        <tbody className="divide-y divide-border">
          {loading ? (
            <tr>
              <td
                colSpan={4}
                className="px-10 py-20 text-center text-xs font-medium text-muted-foreground uppercase tracking-widest italic animate-pulse"
              >
                Querying Brand Repository...
              </td>
            </tr>
            ...
            <tr>
              <td
                colSpan={4}
                className="px-10 py-20 text-center text-xs font-medium text-muted-foreground uppercase tracking-widest italic"
              >
                {emptyMessage}
              </td>
            </tr>
            ...
            brands.map((brand) => {
              ...
              return (
                <tr
                  key={brand.id}
                  className="group hover:bg-muted/50 transition-colors duration-300"
                >
                  <td className="px-10 py-6">
                    <div className="flex items-center gap-6">
                      ...
                      <div className="space-y-1">
                        <div className="text-lg font-serif text-foreground tracking-wide">
                          {brand.name}
                        </div>
                  ...
                  <td className="px-10 py-6">
                    <span className="inline-flex items-center px-3 py-1 text-[10px] font-bold uppercase tracking-widest bg-secondary border border-border text-muted-foreground">
                    ...
                    {productCount > 0 && onViewProducts && (
                      <button
                        ...
                        className="block mt-2 text-[10px] font-bold uppercase tracking-widest text-primary hover:underline"
                      >
                        View products
                      </button>
                    )}
