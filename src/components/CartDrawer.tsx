              ...
              <div className="p-8 bg-[#FDFDFD] border-t border-[#1A1A1A]/5 space-y-6">
                ...
                <div className="space-y-3 pt-4 border-t border-[#1A1A1A]/5">
                  ...
                  <div className="flex gap-2">
                    <button className="flex-1 p-3 border border-[#D4AF37] bg-[#F5F0E1]/30 text-[9px] font-bold uppercase tracking-widest">Standard (3,000 MMK)</button>
                    <button className="flex-1 p-3 border border-[#1A1A1A]/5 text-[9px] font-bold uppercase tracking-widest text-[#1A1A1A]/40 hover:border-[#D4AF37] transition-all">Express (6,500 MMK)</button>
                  </div>
                </div>
                ...
                <div className="space-y-2 pt-4">
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-bold">{subtotal.toLocaleString()} MMK</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-[#1A1A1A]/40 font-medium">Delivery</span>
                    <span className="font-bold">3,000 MMK</span>
                  </div>
                  <div className="pt-4 flex justify-between items-end border-t border-[#1A1A1A]/5">
                    ...
                    <span className="text-xl font-bold text-[#D4AF37]">{(subtotal + 3000).toLocaleString()} MMK</span>
                  </div>
                </div>
